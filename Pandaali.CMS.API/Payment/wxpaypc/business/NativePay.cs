...
namespace WxPayAPI
{
    public class NativePay
    {
        ...
        * @return 模式一URL
        */
        public string GetPrePayUrl(string productId, string body, decimal total)
        {
        ...
        * @return 模式二URL
        */
        public string GetPayUrl(string order_no, string body, decimal total)
        {
            ...
            data.SetValue("total_fee", (int)(total*100));//总金额
