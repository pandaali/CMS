<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="Pandaali.CMS.Web.admin.order.order_confirm" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Pandaali.CMS.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new Pandaali.CMS.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
