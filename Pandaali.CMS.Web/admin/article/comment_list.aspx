<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="Pandaali.CMS.Web.admin.article.comment_list" %>
    ...
    <tr>
      <td class="comment">
        <div class="title">
          ...
          <%#new Pandaali.CMS.BLL.article().GetTitle(Convert.ToInt32(Eval("article_id")))%>
        </div>
        <div class="ask">
