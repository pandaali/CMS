...
namespace Pandaali.CMS.Web.admin.channel
{
    public partial class channel_edit : Web.UI.ManagePage
    {
        ...
        private string GetInherit(string page_type)
        {
            ...
            {
                case "index":
                    result = "Pandaali.CMS.Web.UI.Page.article";
                    break;
                case "category":
                    result = "Pandaali.CMS.Web.UI.Page.category";
                    break;
                case "list":
                    result = "Pandaali.CMS.Web.UI.Page.article_list";
                    break;
                case "detail":
                    result = "Pandaali.CMS.Web.UI.Page.article_show";
                    break;
            }
            return result;
        }
