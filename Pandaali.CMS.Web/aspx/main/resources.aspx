<%@ Page Language="C#" AutoEventWireup="true" Inherits="Pandaali.CMS.Web.UI.Page.resources" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("resources.html\">最新</a>\r\n                </li>\r\n                ");
	DataTable rekuuresourceList = get_category_child_list("resources",0);

	foreach(DataRow dr in rekuuresourceList.Rows)
	{

	templateBuilder.Append("\r\n                <li>\r\n                    <a href=\"");
	templateBuilder.Append(linkurl("resources",Utils.ObjectToStr(dr["id"])));
