<%@ Page Language="C#" AutoEventWireup="true" Inherits="Pandaali.CMS.Web.UI.Page.Default" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	foreach(DataRow ncdr in rekuushareList.Rows)
	{
		ncdr__loop__id++;
	...
	templateBuilder.Append("\r\n                <li class=\"active\">\r\n                    <a href=\"");
	templateBuilder.Append(linkurl("windows_list",Utils.ObjectToStr(ncdr["id"])));
	...
	templateBuilder.Append("\r\n                <!--/类别-->\r\n            </ul>\r\n        </div>\r\n        <!-- #left end -->\r\n        <div class=\"wx_center\">\r\n            <ul id=\"showajaxnews\">\r\n                ");
	DataTable newsList = get_article_list("down", 0, 20, "status=0");
	...
	templateBuilder.Append("\" target=\"_blank\" class=\"wxright\"><p class=\"wxname\">央视财经<span>1小时前</span></p><p class=\"wxtitle\">" + Utils.ObjectToStr(dr["title"]) + "</p></a>\r\n                </li>\r\n                ");
	}	//end for if
	...
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("aspx/plugin/article_share.aspx\">我要分享</a>');\r\n                            } else {\r\n                                $(\"#doshare\").prepend('<a class=\"doshare blue\" href=\"");
	templateBuilder.Append(linkurl("login"));
	...
	DataTable newsList3 = get_article_list("down", 0, 8, "status=0");
