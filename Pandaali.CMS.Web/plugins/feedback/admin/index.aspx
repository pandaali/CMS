<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Pandaali.CMS.Web.Plugin.Feedback.admin.index" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Pandaali.CMS.BLL.channel_site().GetTitle(Eval("site_path").ToString())%></td>
