...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	const string channel = "mac";

	templateBuilder.Append("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\r\n<html xmlns=\"http://www.w3.org/1999/xhtml\">\r\n<head>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />\r\n");
	string category_title = get_category_title(model.category_id,"Mac软件");
	...
	templateBuilder.Append("\r\n        <li>\r\n          <h4><a href=\"");
	templateBuilder.Append(linkurl("mac_list",Utils.ObjectToStr(cdr1["id"])));
	...
	templateBuilder.Append("\r\n            <a href=\"");
	templateBuilder.Append(linkurl("mac_list",Utils.ObjectToStr(cdr2["id"])));
	...
	DataTable redMac = get_article_list(channel, 0, 4, "status=0 and is_red=1 and img_url<>''");
	...
	DataTable hotMac = get_article_list(channel, 0, 10, "status=0", "click desc,id desc");

	int hotdr__loop__id=0;
	foreach(DataRow hotdr in hotMac.Rows)
	{
		hotdr__loop__id++;
	...
	templateBuilder.Append(linkurl("mac_show",Utils.ObjectToStr(hotdr["id"])));
	...
	templateBuilder.Append(get_prevandnext_article("mac_show", -1, "没有了", 0).ToString());

	templateBuilder.Append("</p>\r\n	  <p class=\"next\">下一篇：");
	templateBuilder.Append(get_prevandnext_article("mac_show", 1, "没有了", 0).ToString());

	templateBuilder.Append("</p>\r\n    </div>\r\n    <!--/上下篇-->\r\n    \r\n    <div class=\"line15\"></div>\r\n    <!--相关推荐-->\r\n    <h2 class=\"base-tit\">\r\n      <span>相关资讯</span>\r\n    </h2>\r\n    <div class=\"rel-list\">\r\n      <ul>\r\n        ");
	DataTable relMac = get_article_list(channel, model.category_id, 4, "is_red=1 and img_url<>'' and id<>"+model.id);

	foreach(DataRow dr in relMac.Rows)
	{
