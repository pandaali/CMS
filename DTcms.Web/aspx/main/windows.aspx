...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable windowsList = get_article_list(channel, 0, 9, "status=0");

	int newdr__loop__id=0;
	foreach(DataRow newdr in windowsList.Rows)
	{
		newdr__loop__id++;
	...
	templateBuilder.Append(linkurl("windows_show",Utils.ObjectToStr(newdr["id"])));
	...
	templateBuilder.Append("\r\n<div class=\"section clearfix\">\r\n  <div class=\"ntitle\">\r\n    <h2>\r\n      <a href=\"");
	templateBuilder.Append(linkurl("windows_list",Utils.ObjectToStr(cdr["id"])));
	...
	templateBuilder.Append(linkurl("windows_show",Utils.ObjectToStr(dr1["id"])));
	...
	templateBuilder.Append("</i>\r\n          <a href=\"");
	templateBuilder.Append(linkurl("windows_show",Utils.ObjectToStr(dr2["id"])));
