...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("</a>\r\n    </h2>\r\n    ");
	string category_nav = get_category_menu("mac_list", category_id);
	...
	templateBuilder.Append("\r\n      </ul>\r\n      \r\n    </div>\r\n  </div>\r\n  <!--/右边-->\r\n  \r\n  <!--左边-->\r\n  <div class=\"list-auto\">\r\n    <ul class=\"n-list\">\r\n      ");
	DataTable macList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "mac_list", category_id, "__id__");

	templateBuilder.Append("<!--取得一个分页DataTable-->\r\n      ");
	foreach(DataRow dr in macList.Rows)
	{
